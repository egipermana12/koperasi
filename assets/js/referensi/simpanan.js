...
getData = function(pageStart = 0)
{
    ...
    getAllData(base_url + 'simpananview', element, Form);
};
...
showModal = function()
{
    ...
    $.ajax({
        type: "POST",
        url: base_url + "Referensi/simpanan/create",
...
editData =  function(){
    ...
    $.ajax({
        type: "POST",
        url: base_url + "Referensi/simpanan/edit",
        data: formData,
        processData: false, // tell jQuery not to process the data
        contentType: false,
        success: function(res){
    ...
    if(cek < 0){
        ...
        allowEscapeKey: false
            ...
            if(result.isConfirmed){
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "Referensi/simpanan/delete",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
